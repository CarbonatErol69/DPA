...
class Raumzuweisung():
    ...
    def load_data(self, schueler_wahlen_path, raumliste_path, veranstaltungsliste_path):
    ...
    def verarbeite_schueler_wahlen(self, schuelerwahlen_df):
    ...
    def berechne_mindest_events_anpassung(self, veranstaltungsliste_df, wahlen_haeufigkeiten_df):
    ...
    def identifiziere_mehrfache_veranstaltungen(self, veranstaltungsliste_df):
    ...
    def verteile_veranstaltungen(self, raumliste_df, veranstaltungsliste_df, wahlen_haeufigkeiten_df):
        raum_zu_veranstaltung = {raum: [] for raum in raumliste_df['Raum']}
        unternehmen_mehrfach = self.identifiziere_mehrfache_veranstaltungen(veranstaltungsliste_df)
    ...
    def exportiere_raumzuweisungen(self, raum_zu_veranstaltung, veranstaltungsliste_df, exportpfad):
    ...
    def main(self):
        basisimportpfad = 'C://Users//T1485841//Documents//Projekte//Schulprojekt//DPA//Data//Imports//'
        exportpfad = 'C://Users//T1485841//Documents//Projekte//Schulprojekt//DPA//data//Exports//Raumzuweisungen.xlsx'
        ...
        schuelerwahlen_df, raumliste_df, veranstaltungsliste_df = self.load_data(schueler_wahlen_path, raumliste_path, veranstaltungsliste_path)
        wahlen_haeufigkeiten_df = self.verarbeite_schueler_wahlen(schuelerwahlen_df)
        veranstaltungsliste_df = self.berechne_mindest_events_anpassung(veranstaltungsliste_df, wahlen_haeufigkeiten_df)

        raum_zu_veranstaltung = self.verteile_veranstaltungen(raumliste_df, veranstaltungsliste_df, wahlen_haeufigkeiten_df)
        for raum, veranstaltungen in raum_zu_veranstaltung.items():
            print(f"Raum {raum} beherbergt Veranstaltungen: {veranstaltungen}")


        
        self.exportiere_raumzuweisungen(raum_zu_veranstaltung, veranstaltungsliste_df, exportpfad)
