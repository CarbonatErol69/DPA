...
class Schuelerzuweisung():
    ...
    def main(self):
        ...
        basisexportpfad = 'C://Users//T1485841//Documents//Projekte//Schulprojekt//DPA//data//Exports//'
        exportpfad = 'C://Users//T1485841//Documents//Projekte//Schulprojekt//DPA//data//Exports//Schueler_Zuweisungen.xlsx'

        schueler_wahlen_path = basisimportpfad + 'IMPORT_BOT2_Wahl.xlsx'
        raumliste_path = basisexportpfad + 'Raumzuweisungen.xlsx'
